...
ggplot(loc, aes(x, y, label = method, col = factor(group))) + 
    ...
    ggtitle("MDS of similarity methods on random 500 GO terms")
```
...
are from the heatmap in Figure S4-2.
...
<p class="caption">Figure S4-4. Pairwise comparison between various similarity methods on 500 random GO BP terms. The five groups are defined in the heatmap.</p>
</div>
</div>
