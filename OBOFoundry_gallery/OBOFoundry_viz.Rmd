---
title: "Supplementary File 6. OBO Foundry gallery"
...
ontologies. In this document, we import all ontologies on OBO Foundry and
generate circular visualization, similarity heatmap and runtime performance on them.
...
df = df[, c("id", "title", "n_terms", "n_relations", "is_tree", "avg_parents", "avg_children", "asp1", "asp2", "max_depth")]
df = df[order(-df$n_terms), ]
datatable(df, escape = FALSE, rownames = FALSE,
    colnames = c("id", "title", "n_terms", "n_relations", "is_tree", "pa_avg", "ch_avg", "asp1", "asp2", 'd_max'))
```
...
<div id="heatmap" style="display:none;"><p>The similarity is calculated by the *WP_1994* method.</p><img id="image2" src="image/OBOFoundry_ado_heatmap.png" /></div>
