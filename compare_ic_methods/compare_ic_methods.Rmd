...
We put `"IC_Meng_2012"`, `"IC_Wang_2007"` and `"IC_universal"` into a group called `"others"` because
these three IC vectors show overall low similarities to other IC vectors. 
...
Similar as the heatmap, the three methods of `"IC_Meng_2012"`, `"IC_Wang_2007"` and `"IC_universal"` 
