...
Similar as the heatmap, the two methods of `"IC_Wang_2007"` and `"IC_universal"` 
are quite far from other points in the MDS plot.

We can directly compare different IC methods with pairwise scatter plots, colored by 
depths of terms.
